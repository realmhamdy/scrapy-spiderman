...
import spiderman.models.app_models


class Migration(migrations.Migration):

    dependencies = [
        ('spiderman', '0004_auto_20150915_2348'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='spiderrun',
            name='logfile',
            field=models.FileField(upload_to=spiderman.models.app_models.logfile_uploadto),
        ),
        migrations.AddField(
            model_name='spider',
            name='project',
            field=models.ForeignKey(related_name='spiders', default=None, to='spiderman.SpiderProject'),
